...
solver_path = 'ECE595/cifar/solver/var_num_feature_maxiter6000_lr0.01/'
trace_path = 'ECE595/cifar/traces/var_num_feature_maxiter6000_lr0.01/'

fid = open(filename, 'w')
fid.write(start_text)
for f_size in feature_size_list:
    text = './build/tools/caffe train --solver=' + solver_path + 'cifarlenet_solver_featuresize' + str(f_size) + \
